...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'knp_last_tweets.last_tweets_fetcher.api' => 'getKnpLastTweets_LastTweetsFetcher_ApiService',
            ...
            'twig.extension.knp_last_tweets.twig' => 'getTwig_Extension_KnpLastTweets_TwigService',
        ...
        $this->aliases = array(
            ...
            'knp_last_tweets.last_tweets_fetcher' => 'knp_last_tweets.last_tweets_fetcher.api',
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_262a9cce9c20ed8d944440fc91b370d46328e43982b90ebf67fd3454396ba994');
    ...
    /**
     * Gets the 'endroid.twitter' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Endroid\Twitter\Twitter A Endroid\Twitter\Twitter instance.
     */
    protected function getEndroid_TwitterService()
    {
        return $this->services['endroid.twitter'] = new \Endroid\Twitter\Twitter('R8FKA4ppz7Qc2jjk8v1ETJXH1', 'A0f7ukljQzA6uhh8CKVTyuwU2C6Hj7UJzW48CuDGYjqsiFVDvP', '800536093-DxyFa98jS4EYzx0IdKpQB8edbblW3ahaAZREftng', 'exVWwnpl1c4k6YbYu4qbBThuWJg02dWPR1e8oMhSw', NULL, NULL, 100);
    }
    ...
    /**
     * Gets the 'knp_last_tweets.last_tweets_fetcher.api' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Knp\Bundle\LastTweetsBundle\Twitter\LastTweetsFetcher\ApiFetcher A Knp\Bundle\LastTweetsBundle\Twitter\LastTweetsFetcher\ApiFetcher instance.
     */
    protected function getKnpLastTweets_LastTweetsFetcher_ApiService()
    {
        return $this->services['knp_last_tweets.last_tweets_fetcher.api'] = new \Knp\Bundle\LastTweetsBundle\Twitter\LastTweetsFetcher\ApiFetcher($this->get('buzz'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($h, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.database_users')), 'secured_area', $a, $c), 2 => $j, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $i, 'secured_area', $k, $l, array('check_path' => 'security_login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, $this->get('security.csrf.token_manager')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '572c7ef0d6ea58.56765877', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $h, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $i, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $i, 'security_login_form', false), NULL, NULL, $a, false));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension($this->get('twig.extension.knp_last_tweets.twig'));
    ...
    /**
     * Gets the 'twig.extension.knp_last_tweets.twig' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Knp\Bundle\LastTweetsBundle\Twig\Extension\TweetUrlizeTwigExtension A Knp\Bundle\LastTweetsBundle\Twig\Extension\TweetUrlizeTwigExtension instance.
     */
    protected function getTwig_Extension_KnpLastTweets_TwigService()
    {
        return $this->services['twig.extension.knp_last_tweets.twig'] = new \Knp\Bundle\LastTweetsBundle\Twig\Extension\TweetUrlizeTwigExtension();
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/knplabs/knp-last-tweets-bundle/Knp/Bundle/LastTweetsBundle/Resources/views'), 'KnpLastTweets');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'endroid.twitter.consumer_key' => 'R8FKA4ppz7Qc2jjk8v1ETJXH1',
            'endroid.twitter.consumer_secret' => 'A0f7ukljQzA6uhh8CKVTyuwU2C6Hj7UJzW48CuDGYjqsiFVDvP',
            'endroid.twitter.access_token' => '800536093-DxyFa98jS4EYzx0IdKpQB8edbblW3ahaAZREftng',
            'endroid.twitter.access_token_secret' => 'exVWwnpl1c4k6YbYu4qbBThuWJg02dWPR1e8oMhSw',
            'endroid.twitter.api_url' => NULL,
            'endroid.twitter.proxy' => NULL,
            'endroid.twitter.timeout' => 100,
